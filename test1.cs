public float CalculateParagraphHeight(iTextSharp.text.Paragraph paragraph, PdfWriter writer)
        {
            ...
            column.SetSimpleColumn(0, 0, 555, 802); // Genişlik ve yükseklik ayarlarını dilediğiniz gibi ayarlayabilirsiniz
            column.Go();
        ...
        public void AddNews(List<News> newsList, iTextSharp.text.Document document, PdfWriter writer)
        {
            ...
            foreach (News news in newsList)
            {
                ...
                float paragraphHeight = CalculateParagraphHeight(newsParagraph, writer);
